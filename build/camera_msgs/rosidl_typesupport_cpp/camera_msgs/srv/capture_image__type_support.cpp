...
static const _CaptureImage_Request_type_support_symbol_names_t _CaptureImage_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, camera_msgs, srv, CaptureImage_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, camera_msgs, srv, CaptureImage_Request)),
  }
};
...
{
  return &::camera_msgs::srv::rosidl_typesupport_cpp::CaptureImage_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, camera_msgs, srv, CaptureImage_Request)() {
  return get_message_type_support_handle<camera_msgs::srv::CaptureImage_Request>();
}
...
static const _CaptureImage_Response_type_support_symbol_names_t _CaptureImage_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, camera_msgs, srv, CaptureImage_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, camera_msgs, srv, CaptureImage_Response)),
  }
};
...
{
  return &::camera_msgs::srv::rosidl_typesupport_cpp::CaptureImage_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, camera_msgs, srv, CaptureImage_Response)() {
  return get_message_type_support_handle<camera_msgs::srv::CaptureImage_Response>();
}
...
static const _CaptureImage_type_support_symbol_names_t _CaptureImage_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, camera_msgs, srv, CaptureImage)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, camera_msgs, srv, CaptureImage)),
  }
};
...
{
  return &::camera_msgs::srv::rosidl_typesupport_cpp::CaptureImage_service_type_support_handle;
}
